"""Supplemental cell/calendar verification; original source-equivalence failure remains."""
...
from physics_guided_history_availability.core import POINTS, SOURCE_ROLE, UNKNOWN
from .core import CONFIG_SHA, PLAN_SHA, source_audit, source_guard, specification
...
def verify(out, sealed=True):
    ...
    result = dict(
        passed=True,
        original_run_exitcode=1,
        original_three_source_equivalence_passed=source_checks[
            "original_three_source_equivalence_passed"
        ],
        published_source_equivalence_passed=source_checks[
            "published_source_equivalence_passed"
        ],
