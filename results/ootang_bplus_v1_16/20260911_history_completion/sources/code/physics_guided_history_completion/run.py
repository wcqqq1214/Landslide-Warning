"""Complete the registered history audit supplement; preserve the original failure."""
...
def execute(out):
    ...
    paths = [
        *sorted((ROOT / "code/physics_guided_history_completion").glob("*.py")),
        ROOT / "tests/test_physics_guided_history_completion.py",
        CONFIG,
        ROOT / spec["protocol"],
    ]
    ...
    print(
        json.dumps(
            dict(
                status="completed",
                original_three_source_equivalence_passed=result[
