...
**当前状态：293 日复核已完成，v2.3 神经组件与全历史递推已实现；完整数据/运行接口和同背景 C 重放尚未完成，未训练。**
候选依据、完整记忆递推、独立近似检查和开发先行的停止条件见[v2.3 方案](docs/ootang_probability_pinn_plan.v2.3.md)。
保留 B+，原 v2.1 和力探针继续暂缓，没有新训练预算。
...
| [v2.3 当前候选](docs/ootang_probability_pinn_plan.v2.3.md) | 水文蠕变关系、全历史状态、概率尺度及拟议验收；已有组件及三项检查；尚无训练结果 |
