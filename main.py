...
STAGES = (
    ...
    Stage(
        ...
        inputs=(
            "config/ootang_epoch_settlement_cycle.v1.json",
            "config/ootang_epoch_workset_recovery.v1.json",
            ...
            "code/monitoring/ootang_epoch_step_dependency_overlay.py",
            ...
            "code/monitoring/ootang_epoch_source_derived_current_effective_workset_terminal_coverage.py",
