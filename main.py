...
STAGES = (
    ...
    Stage(
        ...
        outputs=(
            "models/cnn_mamba.pt",
            "figures/cnn_mamba/forecast_interval.png",
            "figures/cnn_mamba/forecast_metrics.csv",
            "figures/cnn_mamba/forecast_period_metrics.csv",
            "figures/cnn_mamba/forecast_calibration_metrics.csv",
            "figures/cnn_mamba/forecast_bootstrap_ci.csv",
        ),
    ),
    Stage(
        "cnn-mamba-rolling",
        ...
        inputs=("data/features.csv", "data/station_coords.csv"),
        outputs=(
            "figures/cnn_mamba/rolling_validation_folds.csv",
            "figures/cnn_mamba/rolling_validation_metrics.csv",
            "figures/cnn_mamba/rolling_validation_predictions.csv",
        ),
    ),
    Stage(
        "cnn-mamba-seeds",
        ...
        inputs=("data/features.csv", "data/station_coords.csv"),
        outputs=(
            "figures/cnn_mamba/seed_stability_runs.csv",
            "figures/cnn_mamba/seed_stability_metrics.csv",
            "figures/cnn_mamba/seed_stability_summary.csv",
            "figures/cnn_mamba/seed_stability_training.csv",
        ),
    ),
    Stage(
        ...
        outputs=(
            "figures/cnn_mamba/inner_validation_runs.csv",
            "figures/cnn_mamba/inner_validation_selection_history.csv",
            "figures/cnn_mamba/inner_validation_refit_history.csv",
            "figures/cnn_mamba/inner_validation_metrics.csv",
            "figures/cnn_mamba/inner_validation_summary.csv",
            "figures/cnn_mamba/inner_validation_predictions.csv",
            "figures/cnn_mamba/inner_validation_comparison.csv",
        ),
    ),
    Stage(
        "cnn-mamba-capacity",
        ...
        outputs=(
            "figures/cnn_mamba/capacity_candidates.csv",
            "figures/cnn_mamba/capacity_selection_summary.csv",
            "figures/cnn_mamba/capacity_selection_history.csv",
            "figures/cnn_mamba/capacity_selected_runs.csv",
            "figures/cnn_mamba/capacity_selected_refit_history.csv",
            "figures/cnn_mamba/capacity_selected_metrics.csv",
            "figures/cnn_mamba/capacity_selected_summary.csv",
            "figures/cnn_mamba/capacity_selected_predictions.csv",
            "figures/cnn_mamba/capacity_selected_comparison.csv",
        ),
    ),
    Stage(
        "ngboost",
