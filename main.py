...
STAGES = (
    ...
    Stage(
        "ootang-ngboost-auto-state-residual",
        "code/warning/ootang_ngboost_auto_state_residual.py",
        "训练藕塘 lag-conditioned residual NGBoost 并重构全时刻五级概率（显式、非正式）",
        inputs=(
            "config/ootang_ngboost_auto_state_residual.v3.json",
            "figures/ngboost_auto_state_ecdf_v2/station_auto_labels.csv",
            "figures/ngboost_auto_state_ecdf_v2/site_auto_labels.csv",
            "figures/ngboost_auto_state_ecdf_v2/label_gate.json",
            "figures/ngboost_auto_state_ecdf_v2/manifest.json",
        ...
        outputs=(
            ...
            "figures/ngboost_auto_state_residual_v3/comparison_metrics.csv",
            "figures/ngboost_auto_state_residual_v3/delta_class_definition.csv",
            "figures/ngboost_auto_state_residual_v3/manifest.json",
            "models/ootang_ngboost_auto_state_residual_v3.pkl",
        ),
        arguments=(
            "--config",
            "config/ootang_ngboost_auto_state_residual.v3.json",
        ),
        warning_artifact_scope=("exploratory_auto_future_state_residual_challenger"),
        formal_warning_output=False,
        enabled_by_default=False,
    ),
    Stage(
        "ootang-advisor-package",
        "code/reporting/ootang_advisor_package.py",
        "机械汇总藕塘既有预测、自动标签、NGBoost、SHAP 与多点预警结果供导师查看（非正式）",
        inputs=(
            "config/ootang_advisor_package.v1.json",
            f"{CONVLSTM_DIAGNOSTIC_ROOT}/seed_stability_0_4/seed_stability_summary.csv",
            "figures/ngboost_auto_state_ecdf_v2/label_state_definition.csv",
            "figures/ngboost_auto_state_ecdf_v2/site_auto_labels.csv",
            "figures/ngboost_auto_state_ecdf_v2/label_gate.json",
            ...
            "figures/ngboost_auto_state_classifier_v1/warning_timeline.pdf",
            "figures/ngboost_auto_state_classifier_v1/site_shap_summary.pdf",
            "figures/warning_operational_draft_v4/ootang_v4_all_station_combined_diagnostic.pdf",
            "figures/warning_operational_draft_v4/ootang_v4_full_warning_timeline.pdf",
        ),
        outputs=(
            "figures/advisor_ootang_v1/table1_convlstm.csv",
            "figures/advisor_ootang_v1/table2_auto_labels.csv",
            "figures/advisor_ootang_v1/table3_classifier_comparison.csv",
            "figures/advisor_ootang_v1/table4_multistation_summary.csv",
            "figures/advisor_ootang_v1/table_s1_acceleration_thresholds.csv",
            "figures/advisor_ootang_v1/advisor_summary.md",
            "figures/advisor_ootang_v1/manifest.json",
        ),
        arguments=("--config", "config/ootang_advisor_package.v1.json"),
        warning_artifact_scope="advisor_research_demo_not_formal",
        formal_warning_output=False,
        enabled_by_default=False,
    ),
)
