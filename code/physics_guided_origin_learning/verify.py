"""Independent paired-source reconstruction, loss blocks, and probability replay."""
            ...
            for seed in range(3):
                ...
                for phase, losses in (("initial", initial), ("final", final)):
                    for key, value in losses.items():
                        close(row[f"{phase}_{key}"], value)
                close(group.iloc[0].loss_before_update, initial["loss"])
