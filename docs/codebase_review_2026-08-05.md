...
> 历史记录说明（2026-08-13）：本文件保留当日的审查发现和当时的 v1/v2/v3 入口状态。随后当前树已删除旧运行入口、旧 30 日 V0 和旧融合代码；不要将本文件中的默认阶段、测试数量或可删候选当作当前状态。当前入口与清理边界见 `README.md`、`design.md` 和 `progress.md`。
