# 起点条件化小型 Transformer：完整小试报告 v1.0
...
| --- | --- | --- | --- |
| 612 | 2018-03-04 | 2018-03-05—2018-12-22 | 校准启动，不计主效果 |
| 792 | 2018-08-31 | 2018-09-01—2019-06-20 | 历史探索 |
| 972 | 2019-02-27 | 2019-02-28—2019-12-17 | 历史探索 |
| 1168 | 2019-09-11 | 2019-09-12—2020-06-30 | 最终探索 |
...
| 旧 Transformer 原版 | 32.638862 | 61.393257 | 9.279082 |
| 旧固定半残差 | 29.789181 | 63.980507 | 8.867132 |
| 旧固定 λ=1 | 29.408014 | 63.148258 | 8.907333 |
| 完整历史注意力 | 42.081238 | 46.468504 | 24.702585 |
| 去显式历史位移的注意力 | 42.866189 | 46.556051 | 24.565083 |
| 历史均匀池化 | 42.369016 | 45.874273 | 24.929915 |
...
![跨时段及配对比较](/Users/wcqqq1214/Project/Landslide-Warning/figures/ootang_transformer_origin_v1/20260914/v1/comparison.png)
...
| --- | --- | --- | --- | --- |
| 792 | 完整历史注意力 | 未过 | 未过 | 0/3 |
| 792 | 去显式历史位移的注意力 | 未过 | 未过 | 0/3 |
| 792 | 历史均匀池化 | 未过 | 未过 | 0/3 |
| 972 | 完整历史注意力 | 通过 | 未过 | 3/3 |
| 972 | 去显式历史位移的注意力 | 通过 | 未过 | 3/3 |
| 972 | 历史均匀池化 | 通过 | 未过 | 3/3 |
| 1168 | 完整历史注意力 | 未过 | 未过 | 0/3 |
| 1168 | 去显式历史位移的注意力 | 未过 | 未过 | 0/3 |
| 1168 | 历史均匀池化 | 未过 | 未过 | 0/3 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 792 | 去显式历史位移的注意力 | -0.851046 | -0.784951 | 3/3 | 未过 | 未过 |
| 792 | 历史均匀池化 | -0.015435 | -0.287778 | 2/3 | 未过 | 未过 |
| 972 | 去显式历史位移的注意力 | -0.076185 | -0.087546 | 2/3 | 未过 | 未过 |
| 972 | 历史均匀池化 | 0.461618 | 0.594231 | 1/3 | 未过 | 未过 |
| 1168 | 去显式历史位移的注意力 | 0.578564 | 0.137502 | 1/3 | 未过 | 通过 |
| 1168 | 历史均匀池化 | -0.275203 | -0.227330 | 3/3 | 未过 | 通过 |
...
| --- | --- | --- | --- | --- |
| ATU1 | 8.068246 | 18.931165 | 17.113114 | 17.032294 |
| ATU5 | 9.115007 | 9.706022 | 12.246730 | 9.833242 |
| MJ3 | 13.016274 | 44.551269 | 43.448587 | 47.276027 |
| MJ1 | 6.297166 | 25.621884 | 25.451902 | 25.578095 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 改进 B+ | 6.901689 | 9.124173 | 14.894908 | 201.642014 | 100.00% | 201.642014 |
| DRIFT1 | 9.109845 | 12.977735 | 7.585014 | 88.559116 | 71.08% | 28.421471 |
| 普通岭回归 | 11.318237 | 12.338214 | 13.077240 | 165.170365 | 100.00% | 165.170365 |
| 旧 Transformer 原版 | 6.883836 | 9.279082 | 14.141969 | 189.836396 | 100.00% | 189.836396 |
| 旧固定半残差 | 6.489278 | 8.867132 | 14.471597 | 195.602840 | 100.00% | 195.602840 |
| 旧固定 λ=1 | 6.539368 | 8.907333 | 14.221640 | 191.714781 | 100.00% | 191.714781 |
| 完整历史注意力 | 21.280412 | 24.702585 | 16.901026 | 158.605569 | 96.76% | 153.596478 |
| 去显式历史位移的注意力 | 20.701848 | 24.565083 | 17.357087 | 170.603619 | 94.80% | 158.973592 |
| 历史均匀池化 | 21.555615 | 24.929915 | 17.374420 | 164.084098 | 94.54% | 152.817065 |
...
![导师固定纵轴四点图](/Users/wcqqq1214/Project/Landslide-Warning/figures/ootang_transformer_origin_v1/20260914/v1/COND_ATTN_mentor.png)

蓝色背景表示训练历史、橙色为完整预测段；历史只显示实测与B+，神经曲线从预测起点开始，避免伪造训练拟合。导师固定纵轴未截任何实测或均值，但95%区间分别有16/10/160/7日超出坐标；[完整范围PNG](../figures/ootang_transformer_origin_v1/20260914/v1/COND_ATTN_full.png)与SVG保留整个区间，评分始终使用完整真实区间。
...
| --- | --- | --- |
| ATU1 | -0.841809 | -16.664558 |
| ATU5 | -7.381353 | -9.911819 |
| MJ3 | 8.779059 | -28.642012 |
| MJ1 | -5.241127 | -29.102601 |
...
- [全部汇总CSV](../results/ootang_transformer_origin_v1/20260914/analysis/phase_summary.csv)、[逐点CSV](../results/ootang_transformer_origin_v1/20260914/analysis/metrics_by_point.csv)、[种子CSV](../results/ootang_transformer_origin_v1/20260914/analysis/seed_summary.csv)、[逐日CSV](../results/ootang_transformer_origin_v1/20260914/analysis/daily_predictions.csv)。
- [图件导航](../figures/ootang_transformer_origin_v1/20260914/README.md)、[最终回执](../results/ootang_transformer_origin_v1/20260914/final_receipt.json)。本地分步提交，未push，不制作PDF；独立17:47:02—19:17:02 UTC自限窗口含准备核验，实际总用时见回执，余额不转用。
