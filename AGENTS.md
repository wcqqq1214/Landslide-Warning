...
2. 当前效果读[冻结KIN校正研究](docs/ootang_tide_correction_results.v1.0.md)、[核验](docs/ootang_tide_correction_validation.v1.0.md)、[回执](results/ootang_tide_correction_v1/20260915/final_receipt.json)，实现追溯对应计划/配置/2216来源；再按需读[前轮联合融合](docs/ootang_tide_fusion_results.v1.0.md)、[K/H输入消融](docs/ootang_tide_features_results.v1.0.md)、[原TiDE配对](docs/ootang_tide_direct_results.v1.0.md)、[历史教师更新](docs/ootang_teacher_refresh_results.v1.0.md)、[训练预算](docs/ootang_training_sufficiency_results.v1.0.md)及[骨干×起点表达](docs/ootang_backbone_anchor_results.v1.0.md)，不恢复历史预算。
