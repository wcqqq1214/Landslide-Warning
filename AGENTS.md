...
- 开始或恢复工作先读本入口、最新 progress、历史预测残差训练核对、加性GP v2结果、B+–GP结果、v2.4 结果、方法决策、v2.3 结果和 293 日复核报告；按需追溯形成时方案。v2.3 已停止，不根据旧配置再次运行。v1.1–v1.25、v2.0 原结果/配置/源码及 v2.1/v2.2 记录保留，旧文档的“下一步”仅为历史背景。研究目标不等于已有结果或导师验收。
