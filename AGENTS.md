...
- 2026-09-12 最新用户授权：“继续下一步，我批准启动新实验”。本轮采用先前提出的 60 分钟总时限，08:24:03—09:24:03 UTC；配置 `config/ootang_probability_pinn.v2_3.json`。只运行 792/376 开发阶段，三种子各 300 次，最多 900 次更新；本轮不训练最终 293 日模型。该授权取代以下历史状态中的“没有新训练预算”，不重置已用完的旧准备额度。
